...
var script = fs.readFileSync(path.join(process.cwd(), 'app/script', envConfig.env, envConfig.script), 'utf8');
...
var Actor = function (conf, aid) {
    ...
    this.scriptPath = path.join(process.cwd(), 'app/script', envConfig.env);
    if (conf.script === envConfig.script) {
        this.script = script;
    } else {
        //console.log('process.cwd():%s ,%s, %s', process.cwd(), envConfig.env, envConfig.script)
        this.script = fs.readFileSync(path.join(process.cwd(), 'app/script', envConfig.env, envConfig.script), 'utf8');
    }
