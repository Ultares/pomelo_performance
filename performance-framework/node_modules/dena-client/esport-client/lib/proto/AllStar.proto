...
message AllStarInfo {
  ...
  optional uint32 open_week_day = 12;				//开启当天的星期几
  repeated uint32 random_team = 13;					//随机的队伍
  optional uint32 get_award_time = 14;				//得到奖励的时间
  optional uint32 get_ticket_num = 15;				//本天奖励中得到的钥匙数
}
