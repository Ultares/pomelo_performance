...
enum EAccountFlagType
{
  ...
  ACCOUNT_FLAG_TYPE_REBATE_ITEMS = 16;      // 返利道具
  ACCOUNT_FLAG_TYPE_REBATE_ITEMS2 = 32;     // 返利钻石
}
...
message AccountInfo 
{
	...
	optional string channel = 8;//渠道ID
	optional bytes version = 9;//客户端版本号
	optional bytes account_type = 10;
