...
message AnswerMatch
{
	...
	optional string match_des            = 10;//赛区描述
}
...
message AnswerSave
{
	optional uint32 datetime = 1;//日期
	optional uint32 count    = 2;//投注额
	optional uint32 question_id   = 3; //问题描述
	optional string question_short= 4; //问题描述
	optional uint32 answer_id     = 5;  //答案描述
	optional string answer_des    = 6;  //答案描述
	optional uint32 rate          = 7;  //倍率
}
