...
enum EStrategyType {
	STRATEGY_TYPE_TACTIC_CORE = 1;                              // 战术核心
	STRATEGY_TYPE_JUNGLE_TEND = 2;                              // 打野倾向
	STRATEGY_TYPE_3 = 3;
	STRATEGY_TYPE_GROUP_FORMATION = 4;                          // 团战阵型
};

message StrategyPosition {
  optional EStrategyType type = 1;                            // 1~4:4个战术位置中的一个
...
message S2C_StrategyUseResponse {
  ...
  optional bool is_opponent = 7;                              // 是否是敌方
}
