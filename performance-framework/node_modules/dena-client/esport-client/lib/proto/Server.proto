...
message MailData
{
	...
	optional int32 level_limit = 7;     //等級限制
	optional bool new_player_limit = 8; //是否限制新号 true 限制
}
...
message ServerMail
{
    repeated uint64 op_uids = 1;
    optional string sid = 2;
    optional MailContext mail_ctx = 3;
}
...
message ServerBestTeam
{
	...
	optional uint32 last_daily_reward_time = 4;//上次每日奖励时间
	optional int32 last_reward_rank = 5;//上次发奖励的记录
}
...
message ServerInfo
{
	...
	optional AuctionInfo auction_info = 9;
    optional ServerHoliday holiday_info = 10;
}

message S2S_CopyAccountRequest
{
...
message S2S_WebGiftCodeVerifyRequest
{
	optional string code = 1;
	optional uint64 player_id = 2;
	optional string global_sid = 3;
...
message S2S_GiftCodeVerifyResponse
{
	...
	optional bool is_web = 5;
}

message S2S_ZLGiftCodeVerifyRequest
{
	optional string code = 1;
	optional uint64 player_id = 2;
	optional string global_sid = 3;
...
message S2S_ZLGiftCodeVerifyResponse
{
	optional int32 res = 1;
...
//answewr
message S2S_GetServerAnswerInfoRequest
{
}

message S2S_GetServerAnswerInfoResponse
{
	optional ServerAnswerInfo server_answer_info = 1;
}

message S2S_GmIntroAnswerRequest
{
	optional int32 macth_id = 1;
	optional int32 index = 2;
}

message S2S_UploadAnswerAmountMsg
{
...
//card comment
message S2S_GetServerCardCommentRequest
{
	repeated uint32 card_id = 1;
}

message S2S_GetServerCardCommentResponse
{
	optional uint32 card_id = 1;
	optional CommentList list = 2;
}

message S2S_AddLikeCardCommentRequest
{
	optional uint32 card_id = 1;
	optional uint64 id = 2;
}

message OneCardCommentLike
{
	optional uint64 id = 1;
	optional uint32 like_num = 2;
}

message CardCommentLike
{
	optional uint32 card_id = 1;
	repeated OneCardCommentLike likes = 2;
}

message S2S_NotifyLikeCardComment
{
	repeated CardCommentLike likes = 1;
}