...
message	MailContext
{
	...
	optional int32 level_limit = 16;    //等級限制
	optional bool new_player_limit = 17;//是否限制新号 true 限制
	optional uint64 belongs_uid = 18;   //邮件所属于角色
	optional uint32 maintain_time = 19; //保留时间
}
...
message MailInfo
{
	...
	repeated MailGetInfo getmails = 4;	//获取的邮件
}
