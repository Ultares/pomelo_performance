...
enum ERankType
{
	...
	ERankType_Card = 6;
	ERankType_Pvp = 7;
	ERankType_GuildValue = 8; //公会战力
	ERankType_Cross = 9;	  //跨服排行榜
}
...
enum ECombatForceSubRank
{
	...
	ECombatForceSubRank_TOP = 1;
	ECombatForceSubRank_JUNGLER = 2;
	ECombatForceSubRank_MID = 3;
	ECombatForceSubRank_ADC = 4;
	ECombatForceSubRank_SUPPORT = 5;
}
...
enum ECardSubRank
{
	ECardSubRank_All = 0;
	ECardSubRank_TOP = 1;
	ECardSubRank_JUNGLER = 2;
	ECardSubRank_MID = 3;
	ECardSubRank_ADC = 4;
	ECardSubRank_SUPPORT = 5;
}
...
message LeaderboardData
{
	...
	optional uint64 card_id = 9;
	optional uint32 best_team_win = 10;
	optional uint32 best_team_total = 11;
	optional uint32 touxiang = 12;
	optional uint32 biankuang = 13;
	optional string extra_name = 14;
	optional string extra_name2 = 15;
	optional uint32 sid = 16;			//服id
}
