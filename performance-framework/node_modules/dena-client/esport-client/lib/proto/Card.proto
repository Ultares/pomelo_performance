...
message CardInfo {
	...
	repeated CardCounter star_counters = 8;      // 曾经拥有过的X星的选手有多少个
	repeated CardCounter quality_counters = 9;   // 曾经拥有过的X品质的选手有多少个
}
...
// 买皮肤
message C2S_CardBuySkinRequest {
  optional int32 skin_id = 1;
}
message S2C_CardBuySkinResponse {
  optional ErrorCode error_code = 1;
  optional int32 skin_id = 2;
}
