...
message ShopItem
{
	...
	optional int32 item_pool_id = 9;	//商品池道具ID
	//optional uint32 pay_num = 10;		//商品需要充值数量
	optional uint32 sale_count_new = 11;	//商品售卖价格
	optional double pay_num_new = 12;	//商品售卖价格
	optional uint32 last_flush_times = 13;//商品上次刷新时间 FFFFFFF为无限
}
...
message ShopInfo
{
	...
	optional uint32 last_flush_time = 2;//上次维护时间
}
...
message S2C_BuyShopItemResponse
{
	...
	repeated IntPair items = 3;			//购买到的奖励
}

message C2S_FlushShopItemRequest
{
