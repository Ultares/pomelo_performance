...
var Bleach = function () {
    ...
    this.thinkTime = [2000, 3000]; // 最大思考时间 单位 : 毫秒
};
...
Bleach.prototype.connect = function (params, cb) {
    ...
    this.socket.on('close', function (result) {
        console.log('[bleachclient.socket.close] tcp-socket closed!');
    })
}

Bleach.prototype.register = function (EProtoId, cb) {
...
Bleach.prototype.unregister = function (EProtoId) {
...
var processPackage = function (self) {
    while (self.packageList.length) {
        ...
        console.log('--> ', package.EProtoId.toString(16))
        if (cb) {
