...
message CopyMonsterReward
{
optional int32          monsterid   = 1;      // 怪物id
optional int32          index       = 2;      // 流水id
repeated CopyRewards    rewards     = 3;      // 掉落奖励
}
...
repeated CopyMonsterReward rewards 	= 10;     // 战斗内怪掉落
}
