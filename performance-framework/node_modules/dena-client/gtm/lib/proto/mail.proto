...
enum MessageMail
{
	...
	eMessageMail_AutoGotAttachment_C 		= 0x17A1;	// 一键领取附件
	eMessageMail_AutoGotAttachment_S 		= 0x17A2;	// 一键领取附件返回
};
...
// 一键领取附件
message MessageAutoGotAttachmentRequest
{
	optional MessageMail 			id 		= 1 [ default = eMessageMail_AutoGotAttachment_C ];
};
message MessageAutoGotAttachmentReponse
{
	optional MessageMail 			id 		= 1 [ default = eMessageMail_AutoGotAttachment_S ];
};
