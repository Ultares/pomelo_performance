...
enum MessageActivity
{
	...
	eMessageActivity_Hosting_C 						= 0x211D;		// 活动挂机请求
	eMessageActivity_Hosting_S 						= 0x211E;		// 活动挂机返回
};
...
enum ErrorcodeActivity
{
	...
	eErrorcodeActivity_BeenInFight					= 0x211807;		// 您已经在战斗中了
	...
	eErrorcodeActivity_ActivityNotOpen1 			= 0x211D01;		// 活动今天暂未开放
	eErrorcodeActivity_ActivityNotBegin 			= 0x211D02;		// 活动还未开始
	eErrorcodeActivity_ActivityNotEnd 				= 0x211D03;		// 活动已经结束
	eErrorcodeActivity_ActivityLvNotEnough 			= 0x211D04;		// 等级不足无法进入
	eErrorcodeActivity_ActivityInvalidLevelID 		= 0x211D05;		// 非法的难度副本ID
	eErrorcodeActivity_ActivityTimesLimit 			= 0x211D06;		// 活动次数不足
	eErrorcodeActivity_ActivityMoneyNotEnough 		= 0x211D07;		// 魂玉不足
	eErrorcodeActivity_ActivityBagNotEnough 		= 0x211D08;		// 背包不足
	eErrorcodeActivity_ActivityIDInvalid 			= 0x211D09;		// 活动ID非法
	eErrorcodeActivity_ActivityNotComplete 			= 0x211D0A;		// 关卡未通过
	eErrorcodeActivity_ActivityInnerError 			= 0x211D0B;		// 内部错误
	eErrorcodeActivity_ActivityStrengthNotEnough 	= 0x211D0C;		// 体力不足
};
...
message MessageGetBossInfoResponse
{
	...
	required uint32 			lastdamage 			= 10;					// 上次伤害值
};
...
{
	optional MessageActivity 	id 					= 1 [ default = eMessageActivity_Hosting_C ];
	required uint32 			activityid 			= 2;	// 活动id
	required uint32 			levelid 			= 3;	// 副本id
};
message MessageHostingResponse
{
	optional MessageActivity 	id 					= 1 [ default = eMessageActivity_Hosting_S ];
	required uint32 			activityid 			= 2;	// 活动id
	required uint32 			levelid 			= 3;	// 副本id
